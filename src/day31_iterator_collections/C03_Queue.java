...
public class C03_Queue {
    ...
    public static void main(String[] args) {
        ...
        // Murat ile Muhammedin arasina bir eleman ekleyelim
        // queue ozelliginden dolayı araya eleman EKLENEMEZ
